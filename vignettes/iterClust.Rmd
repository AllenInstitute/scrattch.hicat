...
```{r}
tmp=plot_co_matrix(co.ratio, cl, max.cl.size=50)
```
...
dend.result <- build_dend(cl.means[select.markers,levels(cl.clean)],l.rank, l.color,nboot=100)
...
markers=c("Slc17a7","Gad2","Sst","Pvalb","Vip","Lamp5","Sncg","Cux2","Rspo1","Rorb","Fezf2","Osr1","Oprk1","Penk","Foxp2","Nxph4","Tshz2","Sla2","Slc17a8","Fam84b")
