...
By default, q1.th is set to 0.5, q.diff.th to 0.7, and q2.th to NULL. 
...
Iterative clustering pipeline tend to produce many clusters, and uncertainty increases as we try to split the clusters at finer resolution. Therefore, it will be very important to access the robustness of clustering result. We solve this problem by performing clustering many times on subsampled cells. 
```{r, echo=FALSE}
result <- run_consensus_clust(norm.dat, niter=50, de.param =de.param, rm.eigen=rm.eigen)
```
