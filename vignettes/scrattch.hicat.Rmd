...
For this demo, we'll select a small subset for clustering: Iptg, Ndnf and Vip neurons. This gives us a set of 262 single-cell transcriptomic profiles to work with.
```{r Filter samples}
