...
//////////////////////////////////////////////////////////////////////////////////////////////////////
// get_cl_means method2: iterate over only the non-zero elements in a column in a sparse matrix, using openMP
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
//[[Rcpp::export]]
Rcpp::NumericMatrix rcpp_get_cl_means_openMP(Rcpp::RObject mat, Rcpp::IntegerVector clAll, int ncores){	
      // call R function to find positions of each cell in matrix
	Function colnames_f("colnames");
	CharacterVector mat_name = colnames_f(mat);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
// get_cl_present method2: iterate over only the non-zero elements in a column in a sparse matrix, using openMP
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
/*The function calls the ColumnMeanSparse*/
//[[Rcpp::export]]
Rcpp::NumericMatrix rcpp_get_cl_present_openMP(Rcpp::RObject mat, Rcpp::IntegerVector clAll, double lowth, int ncores){	
	...
	for (int col_i = 0; col_i < ptr->get_ncol(); col_i++){
		...
		for (int row_i = 0; row_i < nnzero; row_i++){
			...
			res(*(iptr+row_i), mat_cluster_vector[col_i]) += 1;
		}
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
// get_cl_sq_means method2: iterate over only the non-zero elements in a column in a sparse matrix, using openMP
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
/*The function calls the ColumnMeanSparse*/
//[[Rcpp::export]]
Rcpp::NumericMatrix rcpp_get_cl_sqr_means_openMP(Rcpp::RObject mat, Rcpp::IntegerVector clAll, int ncores){	
    // call R function to reorder and subset cluster vector 
	Function colnames_f("colnames");
	CharacterVector mat_name = colnames_f(mat);
